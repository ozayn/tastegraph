...
class TitleMetadata(Base):
    ...
    actors: Mapped[str | None] = mapped_column(String(500), nullable=True)
    writer: Mapped[str | None] = mapped_column(String(500), nullable=True)
    plot: Mapped[str | None] = mapped_column(String(2000), nullable=True)
    ...
    awards: Mapped[str | None] = mapped_column(String(500), nullable=True)
    rated: Mapped[str | None] = mapped_column(String(20), nullable=True)
